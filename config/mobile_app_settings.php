...
return [
    ...
    'descriptions' => [
        ...
        'cloudplay_cloud_id' => 'Acrobits Cloud ID for CSC QR codes and manual login links. Falls back to the CloudPLAY customer username when blank.',
        'cloudplay_qr_format' => 'portal uses the CloudPLAY get-qr-code token (cpdevel-style profiles). csc encodes login username, app password, and Cloud ID (required for CP_Ibratro-style profiles).',
