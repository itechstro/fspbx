...
class DatabaseSeeder extends Seeder
{
    ...
    private function createPermissions()
    {
        $permissions = [
            ...
            ['application_name' => 'Devices', 'permission_name' => 'phone_firmware_view'],
            ['application_name' => 'Devices', 'permission_name' => 'phone_firmware_upload'],
            ['application_name' => 'Devices', 'permission_name' => 'phone_firmware_delete'],
            ...
            ['application_name' => 'System Settings', 'permission_name' => 'ai_usage_rates_view'],
            ['application_name' => 'System Settings', 'permission_name' => 'ai_usage_rates_edit'],
            ...
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_view'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_view_global'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_search_sentiment'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_analytics_view'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_analytics_schedule'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_view_details'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_recording_play'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_recording_download'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_transcription_view'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_transcription_read'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_transcription_create'],
            ['application_name' => 'Recorder', 'permission_name' => 'recorder_transcription_summary'],
            ['application_name' => 'XML CDR', 'permission_name' => 'cdr_analytics_view'],
            ['application_name' => 'XML CDR', 'permission_name' => 'cdr_analytics_schedule'],
            ['application_name' => 'Domains', 'permission_name' => 'domain_license_view'],
            ['application_name' => 'Domains', 'permission_name' => 'domain_license_edit'],
            ['application_name' => 'Domains', 'permission_name' => 'domain_license_usage_details_view'],
            ...
            ['application_name' => 'Class of Service', 'permission_name' => 'class_of_service_view'],
            ['application_name' => 'Class of Service', 'permission_name' => 'class_of_service_add'],
            ['application_name' => 'Class of Service', 'permission_name' => 'class_of_service_edit'],
            ['application_name' => 'Class of Service', 'permission_name' => 'class_of_service_delete'],
            ['application_name' => 'Extensions', 'permission_name' => 'extension_class_of_service'],
            ...
            ['application_name' => 'Contacts', 'permission_name' => 'contact_view'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_add'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_edit'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_delete'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_all'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_upload'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_domain_view'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_user_view'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_user_add'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_user_edit'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_user_delete'],
            ['application_name' => 'Contacts', 'permission_name' => 'contact_group_view'],
    ...
    private function createGroupPermissions()
    {
        $permissionsByGroup = [
            'superadmin' => [
                ...
                'recorder_view',
                'recorder_view_global',
                'recorder_search_sentiment',
                'recorder_analytics_view',
                'recorder_analytics_schedule',
                'recorder_view_details',
                'recorder_recording_play',
                'recorder_recording_download',
                'recorder_transcription_view',
                'recorder_transcription_read',
                'recorder_transcription_create',
                'recorder_transcription_summary',
                'cdr_analytics_view',
                'cdr_analytics_schedule',
                'domain_license_view',
                'domain_license_edit',
                'domain_license_usage_details_view',
                'messages_view',
                'messages_view_as',
                'xml_cdr_view_all_records',
                'call_block_view_all_records',
                'class_of_service_view',
                'class_of_service_add',
                'class_of_service_edit',
                'class_of_service_delete',
                'extension_class_of_service',
    ...
    private function createMobileAppSettings()
    {
        $settings = [
            ...
            [
                ...
                'default_setting_description'   => 'Optional legacy Acrobits Cloud ID.',
            ],
            [
                'default_setting_category'      => 'mobile_apps',
    ...
    private function createDefaultSettings()
    {
        $settings = [
            ...
            [
                'default_setting_category'      => 'limit',
                'default_setting_subcategory'   => 'ai_transcription_minutes',
                'default_setting_name'          => 'numeric',
                'default_setting_value'         => '1000',
                'default_setting_enabled'       => false,
                'default_setting_description'   => 'Monthly AI transcription minutes per tenant. Disabled = unlimited.',
            ],
            [
                'default_setting_category'      => 'limit',
                'default_setting_subcategory'   => 'ai_summary_requests',
                'default_setting_name'          => 'numeric',
                'default_setting_value'         => '1000',
                'default_setting_enabled'       => false,
                'default_setting_description'   => 'Monthly AI call summary requests per tenant. Disabled = unlimited.',
            ],
            [
                'default_setting_category'      => 'limit',
                'default_setting_subcategory'   => 'ai_translation_requests',
                'default_setting_name'          => 'numeric',
                'default_setting_value'         => '1000',
                'default_setting_enabled'       => false,
                'default_setting_description'   => 'Monthly AI translation requests per tenant. Disabled = unlimited.',
            ],
            [
                'default_setting_category'      => 'limit',
                'default_setting_subcategory'   => 'ai_executive_summary_requests',
                'default_setting_name'          => 'numeric',
                'default_setting_value'         => '100',
                'default_setting_enabled'       => false,
                'default_setting_description'   => 'Monthly recorder analytics executive summary requests per tenant. Disabled = unlimited.',
            ],
            [
                'default_setting_category'      => 'limit',
                'default_setting_subcategory'   => 'ai_spend_usd_monthly',
                'default_setting_name'          => 'numeric',
                'default_setting_value'         => '50',
                'default_setting_enabled'       => false,
                'default_setting_description'   => 'Monthly estimated AI spend cap in USD per tenant. Disabled = unlimited.',
            ],
            [
                'default_setting_category'      => 'limit',
            ...
            [
                ...
                'default_setting_enabled'       => false,
                'default_setting_description'   => 'Monthly outbound call minutes per tenant. Disabled = unlimited.',
            ],
            [
                'default_setting_category'      => 'limit',
