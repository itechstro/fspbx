...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/recorder/analytics', [RecorderAnalyticsController::class, 'index'])->name('recorder.analytics.index');
    ...
    // Call Permissions
    Route::get('call-permissions', [CallPermissionController::class, 'index'])->name('call-permissions.index');
    Route::get('call-permissions/export', [CallPermissionController::class, 'export'])->name('call-permissions.export');
