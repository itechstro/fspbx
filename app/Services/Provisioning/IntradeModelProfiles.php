...
class IntradeModelProfiles
{
    ...
    private static function videoDefaults(): array
    {
        return [
            ...
            'intrade_sidekey_label_length' => '0',
            ...
            'intrade_missed_call_popup' => '0',
            'intrade_mwi_popup' => '0',
            'intrade_device_connect_popup' => '0',
            'intrade_sms_popup' => '0',
            'intrade_other_popup' => '1',
            'intrade_display_provision_prompt' => '0',
            // Old Video firmwares often stall if common.cfg 404s after the MAC cfg.
            'intrade_download_common_conf' => '0',
        ];
    }
    ...
    private static function entryDefaults(): array
    {
        return [
            ...
            'intrade_dss_long_press_action' => '1',
            'intrade_sidekey_label_length' => '2',
            'intrade_side_key_pages' => '3',
            'intrade_auto_blf_list' => '1',
            'intrade_timeout_to_screensaver' => '0',
            'intrade_timeout_to_power_saving' => '360',
            'intrade_power_saving' => '1',
            'intrade_display_language' => 'en;cn;tc;ru;it;fr;de;he;es;cat;eus;gal;tr;hr;slo;cz;nl;ko;ua;pt;pl;ar;jp;kr;',
    ...
    private static function standardDefaults(): array
    {
        return [
            ...
            'intrade_sidekey_label_length' => '1',
            'intrade_side_key_pages' => '3',
            'intrade_auto_blf_list' => '1',
            'intrade_softkey_mode' => '1',
            'intrade_softkey_exit' => '2',
