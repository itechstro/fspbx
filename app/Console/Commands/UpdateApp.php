...
use App\Console\Commands\Updates\Update278;
use App\Console\Commands\Updates\Update196;
use App\Console\Commands\Updates\Update197;
use App\Console\Commands\Updates\Update279;
...
use App\Console\Commands\Updates\Update239;
use App\Console\Commands\Updates\Update240;
use App\Console\Commands\Updates\Update241;
use App\Console\Commands\Updates\Update242;
use App\Console\Commands\Updates\Update243;
use App\Console\Commands\Updates\Update244;
use App\Console\Commands\Updates\Update245;
use App\Console\Commands\Updates\Update246;
use App\Console\Commands\Updates\Update247;
use App\Console\Commands\Updates\Update248;
use App\Console\Commands\Updates\Update249;
use App\Console\Commands\Updates\Update250;
use App\Console\Commands\Updates\Update251;
use App\Console\Commands\Updates\Update252;
use App\Console\Commands\Updates\Update253;
use App\Console\Commands\Updates\Update254;
use App\Console\Commands\Updates\Update255;
use App\Console\Commands\Updates\Update256;
use App\Console\Commands\Updates\Update257;
use App\Console\Commands\Updates\Update258;
use App\Console\Commands\Updates\Update259;
use App\Console\Commands\Updates\Update260;
use App\Console\Commands\Updates\Update261;
...
use App\Console\Commands\Updates\Update267;
use App\Console\Commands\Updates\Update268;
use App\Console\Commands\Updates\Update269;
use App\Console\Commands\Updates\Update270;
use App\Console\Commands\Updates\Update271;
use App\Console\Commands\Updates\Update272;
use App\Console\Commands\Updates\Update273;
use App\Console\Commands\Updates\Update274;
...
class UpdateApp extends Command
{
    ...
    public function handle()
    {
        ...
        $updateSteps = [
            ...
            '1.8.8.46' => Update239::class,
            '1.8.8.47' => Update240::class,
            '1.8.8.48' => Update241::class,
            '1.8.8.49' => Update242::class,
            '1.9.0.1' => Update243::class,
            '1.9.0.2' => Update244::class,
            '1.9.0.3' => Update245::class,
            '1.9.0.4' => Update246::class,
            '1.9.0.5' => Update247::class,
            '1.9.0.6' => Update248::class,
            '1.9.0.7' => Update249::class,
            '1.9.0.8' => Update250::class,
            '1.9.0.9' => Update251::class,
            '1.9.0.10' => Update252::class,
            '1.9.0.11' => Update253::class,
            '1.9.0.12' => Update254::class,
            '1.9.0.13' => Update255::class,
            '1.9.0.14' => Update256::class,
            ...
            '1.9.3.2' => Update261::class,
            '1.9.3.3' => Update262::class,
            '1.9.3.4' => Update263::class,
            '1.9.3.6' => Update265::class,
            '1.9.3.7' => Update266::class,
            '1.9.3.8' => Update267::class,
            '1.9.3.9' => Update268::class,
            '1.9.3.10' => Update269::class,
            '1.9.3.11' => Update270::class,
            '1.9.3.12' => Update271::class,
            ...
            '1.9.6.1' => Update278::class,
            '1.9.7' => Update279::class,
