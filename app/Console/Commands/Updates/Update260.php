...
/**
 * PHP-FPM runs with ProtectSystem=full, which makes /etc read-only unless
 * /etc/freeswitch is listed in ReadWritePaths. The override must exist and
 * php8.4-fpm must be restarted before Let's Encrypt can install certs from
 * the web UI.
 */
class Update260
{
