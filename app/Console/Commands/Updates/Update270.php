...
class Update270
{
    private const VERSION = '1.9.3.11';

    private const MENU_TITLE = 'Class of Service';

    private const MENU_LINK = '/class-of-service';

    public function apply(): bool
    {
        try {
            $this->ensureClassOfServiceMenuItem();
    ...
    private function ensureClassOfServiceMenuItem(): void
    {
        $menu = Menu::query()
        ...
        if (! $menu) {
            echo "Menu 'fspbx' was not found; skipping Class of Service menu item.\n";
        ...
        if (! $applicationsItem) {
            echo "Applications menu item was not found; skipping Class of Service menu item.\n";
        ...
        if (! $menuItem) {
            ...
            echo 'Added Class of Service menu item under Applications.' . PHP_EOL;
        } else {
            $menuItem->forceFill([
                'menu_item_title' => self::MENU_TITLE,
                'menu_item_link' => self::MENU_LINK,
            ...
            echo 'Class of Service menu item already exists; ensured title and link.' . PHP_EOL;
        }
