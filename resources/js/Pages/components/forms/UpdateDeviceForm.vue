                                                    ...
                                                    <template #default="{ index }">
                                                        <ObjectElement :name="index"
                                                            ...
                                                            <TextElement name="key_label" label="Label" :columns="{
                                                                ...
                                                                :floating="false" :disabled="keyLabelDisabledConditions('device_keys', options?.item?.device_vendor)" />
                                                    ...
                                                    <template #default="{ index }">
                                                        <ObjectElement :name="index"
                                                            ...
                                                            <SelectElement name="key_value_select" label="Value"
                                                                ...
                                                                :conditions="[
                                                                    ['side_keys.*.key_type', keyTypesWithSelect]
                                                                ]" />
                                                            ...
                                                            <TextElement name="key_value_text" label="Value" :columns="{
                                                                ...
                                                                ['side_keys.*.key_type', '!=', keyTypesWithValueText]
                                                            ]" />
                                                            ...
                                                            <TextElement name="key_label" label="Label" :columns="{
                                                                ...
                                                                :floating="false" :disabled="keyLabelDisabledConditions('side_keys', options?.item?.device_vendor)" />
                                                    ...
                                                    <template #default="{ index }">
                                                        <ObjectElement :name="index"
                                                            ...
                                                            <TextElement name="key_label" label="Label" :columns="{
                                                                ...
                                                                :floating="false" :disabled="keyLabelDisabledConditions('multi_purpose_keys', options?.item?.device_vendor)" />
                                                    ...
                                                    <template #default="{ index }">
                                                        <ObjectElement :name="index"
                                                            ...
                                                            <TextElement name="key_label" label="Label" :columns="{
                                                                ...
                                                                :floating="false" :disabled="keyLabelDisabledConditions('expansion_keys', options?.item?.device_vendor)" />
