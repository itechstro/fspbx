...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-meta">
            {{ $data['date'] }} &bull; 時長：{{ $data['duration'] }}
        </div>
    ...
    <div class="section">
        <div class="section-title">待辦事項與後續步驟</div>
    ...
    <div class="script-container">
        <div class="section-title" style="margin-bottom: 20px; text-align: center;">完整對話紀錄</div>
